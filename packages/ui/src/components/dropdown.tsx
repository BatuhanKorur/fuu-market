...
export const DropdownTrigger = forwardRef<Element<typeof radix.Trigger>, ComponentPropsWithoutRef<typeof radix.Trigger>>(
  ({ ...props }, ref) => (
    <radix.Trigger ref={ref} className={Styles({ type: 'trigger' })} {...props} />
  ),
)
...
>(({ className, ...props }, ref) => (
  <radix.Separator
    ref={ref}
    className={cx(Styles({ type: 'separator' }), className)}
    {...props}
  />
))
